...
namespace packt.FoodyGO.TouchInput
{
    ...
    public class CustomTouchPad : MonoBehaviour, IPointerDownHandler, IPointerUpHandler
    {
    ...
    private Image m_Image;
        ...
        public void AROn(bool value)
        {
            if (value)
            {
                print("AR is on!");

                Camera.main.transform.rotation = Quaternion.Euler(0, -Input.compass.magneticHeading, 0);
        ...
        void Update()
        {
            ...
            pointerDelta.y *= Ysensitivity;
                ...
                m_PreviousMouse = new Vector3(Input.mousePosition.x, 0, 0);//Input.mousePosition.y, 0f);
#endif
                UpdateVirtualAxes(new Vector3(pointerDelta.x, 0, 0));//pointerDelta.y, 0));
            }
        }
